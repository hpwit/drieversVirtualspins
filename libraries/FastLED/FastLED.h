...
#ifdef I2SESP32
//@support for the parallel output controllers in I2S for esp32 and WS2812B

template<EBlockChipsets CHIPSET, int NUM_LANES,EOrder RGB_ORDER, int PIN1=-1,int PIN2=-1,int PIN3=-1,int PIN4=-1,int PIN5=-1,int PIN6=-1,int PIN7=-1,int PIN8=-1,int PIN9=-1,int PIN10=-1,int PIN11=-1,int PIN12=-1,int PIN13=-1,int PIN14=-1,int PIN15=-1,int PIN16=-1,int PIN17=-1,int PIN18=-1,int PIN19=-1,int PIN20=-1,int PIN21=-1,int PIN22=-1>
	static CLEDController &addLeds(struct CRGB *data, int nLedsOrOffset, int nLedsIfOffset = 0) {
	Serial.println("we get her");
		return addLeds(new I2SBlockClocklessController<NUM_LANES,RGB_ORDER,PIN1,PIN2,PIN3,PIN4,PIN5,PIN6,PIN7,PIN8,PIN9,PIN10,PIN11,PIN12,PIN13,PIN14,PIN15,PIN16,PIN17,PIN18,PIN19,PIN20,PIN21,PIN22>(), data, nLedsOrOffset, nLedsIfOffset);
	}

template<EBlockChipsets CHIPSET, int NUM_LANES,int PIN1=-1,int PIN2=-1,int PIN3=-1,int PIN4=-1,int PIN5=-1,int PIN6=-1,int PIN7=-1,int PIN8=-1,int PIN9=-1,int PIN10=-1,int PIN11=-1,int PIN12=-1,int PIN13=-1,int PIN14=-1,int PIN15=-1,int PIN16=-1,int PIN17=-1,int PIN18=-1,int PIN19=-1,int PIN20=-1,int PIN21=-1,int PIN22=-1>
	static CLEDController &addLeds(struct CRGB *data, int nLedsOrOffset, int nLedsIfOffset = 0) {
		
		return addLeds<CHIPSET,NUM_LANES,GRB,PIN1,PIN2,PIN3,PIN4,PIN5,PIN6,PIN7,PIN8,PIN9,PIN10,PIN11,PIN12,PIN13,PIN14,PIN15,PIN16,PIN17,PIN18,PIN19,PIN20,PIN21,PIN22>(data,nLedsOrOffset,nLedsIfOffset);
	}
#endif
